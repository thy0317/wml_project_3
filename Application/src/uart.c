...
void Uart4Init(void)
{
    GPIO_InitTypeDef uart4_pin_init;
    ...
    /* PC10 - tx  PC11 - rx */
    uart4_pin_init.GPIO_Pin = GPIO_Pin_11;
    uart4_pin_init.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    uart4_pin_init.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOC, &uart4_pin_init);

    uart4_pin_init.GPIO_Pin = GPIO_Pin_10;
    uart4_pin_init.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_Init(GPIOC, &uart4_pin_init);
